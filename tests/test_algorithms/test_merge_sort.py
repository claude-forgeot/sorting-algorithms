...
def test_already_sorted(already_sorted):
    assert merge_sort(already_sorted) == already_sorted


def test_reverse_sorted(reverse_sorted):
    assert merge_sort(reverse_sorted) == sorted(reverse_sorted)


def test_with_duplicates(with_duplicates):
    assert merge_sort(with_duplicates) == sorted(with_duplicates)
